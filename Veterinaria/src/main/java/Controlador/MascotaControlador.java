...
public class MascotaControlador {
    ...
    public void almacenarMascota( String nombre,String raza,int edad,String vacunas,String tipo,String id,double peso,String fechaIngreso,
    ...
    public void consultarMascota(String id){
        ...
        if(mascota == null){
            operacionExitosa("El número de identificacion ingresado no coincide con ninguno de "
    ...
    public void eliminarMascota(String id){
        ...
        if(mascotaNegocio.eliminarMascota(id)){
            ...
            JOptionPane.showMessageDialog(null, "Ningúna mascota coincide con el número de identificacion ingresado",
                    "Mascota no encontrado", JOptionPane.ERROR_MESSAGE);
        }
    }
